...
* `aws_access_key` - (Required) AWS Access Key of an account with the required
permissions to post logs.
* `aws_secret_key` - (Required) AWS Secret Key of an account with the required
permissions to post logs.
